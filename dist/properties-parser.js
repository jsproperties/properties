...
exports.arrayToProperties = arrayToProperties;
...
var parseToArrayOptions = ['all', // Include empty and blank lines
...
function parseToProperties(input, options) {
  var parsedArray = parseToArray(input);
 ...
 */
function arrayToProperties(array, options) {
